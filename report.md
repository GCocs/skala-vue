...
그림 1. AboutView에 REDRED와 cortis 문구를 추가한 화면
...
그림 2. Vue Devtools에서 프로젝트의 라우팅 정보를 확인한 화면
...
그림 3. 도시 검색, 기온 라벨, 카드 선택 결과를 확인한 화면
...
그림 4. 상세보기 버튼을 눌렀을 때 도시의 날씨가 표시된 화면
...
그림 5. 선택 도시와 검색어 변화 로그, 검색 결과 없음을 함께 확인한 화면
...
그림 6. 25도 이상 필터, 높은순 정렬, 평균 기온을 적용한 화면
